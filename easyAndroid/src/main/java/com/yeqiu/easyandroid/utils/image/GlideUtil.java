...
public class GlideUtil {
    ...
    /*** 占位图 */
    public static int placeholderImage = com.yeqiu.easyandroid.R.drawable.icon_image_placeholder;
    /*** 错误图 */
    public static int errorImage = com.yeqiu.easyandroid.R.drawable.icon_image_placeholder;
    ...
    @SuppressLint("CheckResult")
    private static RequestOptions getOptions(ScaleType scaleType) {
     ...
     *
     * @param context         上下文
     * @param urlOrDrawableId url 或者 drawable资源
     * @param imageView       ImageView
     */
    public static void loadImage(Context context, Object urlOrDrawableId, ImageView imageView) {

        RequestOptions options = getOptions();
        Glide.with(context)
                .load(urlOrDrawableId)
                .apply(options)
                .into(imageView);
    }
     ...
     * @param imageView       ImageView
     */
    public static void loadImage(Context context, Object urlOrDrawableId, ImageView imageView, ScaleType scaleType) {

        RequestOptions options = getOptions(scaleType);
        Glide.with(context)
                .load(urlOrDrawableId)
                .apply(options)
                .into(imageView);
    ...
    public static void loadCircleWithBorderImage(Context context, String url, ImageView imageView,
        ...
        RequestOptions options = RequestOptions.bitmapTransform(
                new MultiTransformation<>(
                        new CenterCrop(),
                        new CropCircleWithBorderTransformation((int) ScreenUtils.px2dp(borderSize), borderColor)
                ))
                .override(Target.SIZE_ORIGINAL, Target.SIZE_ORIGINAL)
     ...
     *
     * @param context         上下文
     * @param urlOrDrawableId 链接或资源id
     * @param imageView       ImageView
     * @param radius          圆角 px
     */
    public static void loadRoundCircleImage(Context context, Object urlOrDrawableId, ImageView imageView,
                                            float radius) {
        RequestOptions options = RequestOptions.bitmapTransform(
                new MultiTransformation<>(
                        new CenterCrop(),
                        new RoundedCornersTransformation((int) ScreenUtils.px2dp(radius), 0,
                ...
                .placeholder(placeholderImage) //占位图
                .error(errorImage);            //错误图
        Glide.with(context).load(urlOrDrawableId).apply(options).into(imageView);
     ...
     *
     * @param context         上下文
     * @param urlOrDrawableId 链接 or drawableId
     * @param imageView       ImageView
     * @param width           图片宽度
     * @param height          图片高度
     */
    public static void loadImageSize(Context context, String urlOrDrawableId, ImageView imageView, int width, int height) {
        RequestOptions options = new RequestOptions()
                .placeholder(placeholderImage) //占位图
                .error(errorImage)             //错误图
     ...
     *
     * @param context         上下文
     * @param urlOrDrawableId 链接
     * @param imageView       ImageView
     */
    public static void loadGif(Context context, Object urlOrDrawableId, ImageView imageView) {
        RequestOptions options = new RequestOptions()
                .placeholder(placeholderImage) //占位图
                .error(errorImage)            //错误图
