package com.yeqiu.easyandroid.utils.image.progress;
...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.yeqiu.easyandroid.utils.image.progress.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.yeqiu.easyandroid.utils.image.progress.GlideOptions().apply(toSet));
    }
  }
}
